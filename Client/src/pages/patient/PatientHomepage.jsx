    ...
    return (
      <main>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-6">
          <CardDataStats
            title="Raised Total"
            total={`${Data?.totalRaisedMoney.toLocaleString()} Birr`}
          >
            <svg
          ...
          <CardDataStats title="Donors" total={Data?.donations}>
            <svg
              className="fill-primary-500 dark:fill-white"
              width="22"
              height="16"
          ...
          <CardDataStats
            title="Raised Today"
            total={`${Data?.raisedMoneyToday.toLocaleString()} Birr`}
          >
            <svg
              className="fill-primary-500 dark:fill-white"
              width="22"
        ...
        <div className=" mt-9 max-h-[410px] border-spacing-1 justify-between rounded-md shadow-2xl lg:flex ">
          <div className=" noscroll overflow-auto rounded-md bg-white p-5 shadow-2xl lg:w-[49%]">
