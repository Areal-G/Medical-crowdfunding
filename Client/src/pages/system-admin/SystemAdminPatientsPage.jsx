...
const SystemAdminPatientsPage = () => {
    ...
    if (!isModalOpen) {
      try {
        const response = await API.get(
          `/sysadmin/getpatientdataforadmin/${id}`,
        );
  ...
  const fetchData = async () => {
    try {
      const response = await API.get(`/sysadmin/getpatientstable`);
...
export default SystemAdminPatientsPage;
