...
const HospitalAdminNav = () => {
  ...
  return (
    <div>
      ...
      {/* side bar */}
      <aside
        className={` ${isNavOpen ? "translate-x-0" : "md:translate-x-0"} fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-14 transition-transform dark:border-gray-700 dark:bg-gray-800 `}
      >
